...
maha_gdf = gpd.read_file("data/MADHYA PRADESH_DISTRICTS.geojson")
...
rain_df = pd.read_csv("data/MP_precipitation.csv", parse_dates=["date"])
temp_df = pd.read_csv("data/MP_temperature.csv", parse_dates=["date"])
